model PSBatteryStack
  ...
  final parameter Modelica.Units.SI.Time tini(fixed=false) "Initial time";
  //External Ports
  ...
  Modelica.Blocks.Sources.ContinuousClock clock(final startTime=tini)
  ...
  Modelica.Blocks.Tables.CombiTable1Dv sococvTable(
    ...
    final fileName=cellParameters.SOCOCV.OCVfileName) annotation (Placement(
        transformation(extent={{-70,-80},{-50,-60}}, rotation=0)));
  PSCellCalculator cellCalculator(final SOCini = SOCini, final Z0 = cellParameters.Rs.R0, final capacity = cellParameters.capacity, final SoH = cellParameters.SoH) annotation (
...
equation
  ...
  connect(iBatt.i[1], gain1.u) annotation (
    Line(points={{-9.5,60},{-18,60}},     color = {0, 0, 127}));
  connect(gain.y, Uo.vDC_in) annotation(Line(points={{-19,-70},{-16,-70},{-16,-64},
          {-10,-64}},                                                                                   color = {0, 0, 127}));
  ...
  connect(clock.y, cellCalculator.t) annotation (
    Line(points={{-28.4,36},{-42,36},{-42,56},{-51,56}},        color = {0, 0, 127}));
  connect(const.y, cellCalculator.Z) annotation (
    Line(points={{-28.4,24},{-46,24},{-46,52},{-51,52}},        color = {0, 0, 127}));
  connect(cellCalculator.SOC, sococvTable.u[1]) annotation (
    Line(points={{-71,64},{-88,64},{-88,-70},{-72,-70}},          color = {0, 0, 127}));
  ...
  connect(constTemp.y, cellCalculator.T) annotation (
    Line(points={{-39,88},{-46,88},{-46,64},{-51,64}},          color = {0, 0, 127}));
  ...
  annotation (
    ...
    uses(
      ...
      ElectricalEnergyStorage(version="3.2.3"),
      PowerSystems(version="2.0.1")),
    version="1",
